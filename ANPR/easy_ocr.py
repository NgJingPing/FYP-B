                    ...
                    if file_exists == True:
                        ...
                        for i in indices_2:
                            ...
                            if file_exists == True:
                                ...
                                if len(result) > 0:
                                    plate_num = result[0][-2].upper()
                                    plate_num = ''.join(e for e in plate_num if e.isalnum())
                                    if found == False :
                                        if "Q" not in plate_num[0] and "0" in plate_num[0]:
                                            plate_num = plate_num[0].replace("0", "Q" ) + plate_num[1:]
                                        elif "Q" not in plate_num[0] and "O" in plate_num[0]:
                                            plate_num = plate_num[0].replace("O", "Q" ) + plate_num[1:]
                                        elif "Q" in plate_num[1:] and "O" in plate_num[1:]:
                                            plate_num =  plate_num[0] + plate_num[1:].replace("O", "0" )
                                        if "O" in plate_num[0:]:
                                            plate_num =  plate_num.replace("O", "0" )
