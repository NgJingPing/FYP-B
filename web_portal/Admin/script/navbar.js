window.onload=function(){
  ...
  function expand() {
    ...
    <span style="display:flex;">
      ...
      <span style="width:100%; position:relative; left:-30px;">
        <span style="display:flex; gap:5px;">
          <div><img style="width:130px" src="../images/naim.png" class="naim_logo"></img></div>
          <div style="display:flex;">
            <span class="logo" style="font-size: 1.5rem;" ><span class="logo_initial">V</span><span>ISION</span></span> 
